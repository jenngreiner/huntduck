...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PlayerNumbering : MonoBehaviourPunCallbacks
    {
        ...
        public void RefreshData()
        {
            ...
            foreach (Player player in sorted)
            {
                ...
                if (player.IsLocal)
                {
                    Debug.Log("PlayerNumbering.cs: PhotonNetwork.CurrentRoom.PlayerCount = " + PhotonNetwork.CurrentRoom.PlayerCount);
            ...
            //Debug.Log("PlayerNumbering.cs: allPlayers = " + allPlayers);
            //Debug.Log("PlayerNumbering.cs: PhotonNetwork.LocalPlayer.ToStringFull() + " has PhotonNetwork.player.GetPlayerNumber(): " + PhotonNetwork.LocalPlayer.GetPlayerNumber());
    ...
    public static class PlayerNumberingExtensions
    {
        ...
        public static void SetPlayerNumber(this Player player, int playerNumber)
        {
            ...
            {
                Debug.Log("PlayerNumbering.cs: Set number " + playerNumber);
