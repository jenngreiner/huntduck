...
namespace Photon.Voice.PUN
{
    ...
    public class PhotonVoiceView : VoiceComponent
    {
        ...
        //TODO: Validate new GPT start method to fix dupe recorder.
        private void Start()
        {
            if (photonView.IsMine)
            {
                // Use the global PrimaryRecorder to avoid creating duplicate recorders
                this.RecorderInUse = punVoiceClient.PrimaryRecorder;
                if (this.RecorderInUse == null)
                {
                    this.Logger.Log(LogLevel.Warning, "Local Recorder not set in PhotonVoiceManager.PrimaryRecorder.");
                }
            }
            else
            {
                // Remote players should only set up a Speaker to receive voice
                this.SetupSpeaker();
            }
        }
        ...
        //    if (photonView.IsMine)
        //    {
        //        // Instead of setting up a new Recorder, use the global PrimaryRecorder from the PhotonVoiceManager.
        //        this.RecorderInUse = punVoiceClient.PrimaryRecorder;
        //        if (this.RecorderInUse == null)
        //        {
        //            this.Logger.Log(LogLevel.Warning, "Local Recorder not set in PhotonVoiceManager.PrimaryRecorder.");
        ...
        //        else
        //        {
        //            Debug.Log("Local Recorder already set as PrimaryRecorder: " + this.RecorderInUse.name);
        //        }
        //    }
        //    else
        //    {
        //        // For remote players, set up the recorder normally.
        //        this.SetupRecorder();
        //    }
        ...
        //    {
        //        Debug.Log("Speaker connected: " + this.SpeakerInUse.name);
        //    }
        //    else
        //    {
        //        Debug.LogWarning("Speaker NOT connected.");
        //    }
        //    if (this.SpeakerInUse == null)
        //    {
        ...
        //        if (this.RecorderInUse != null)
        //        {
        //            Debug.Log("Local Recorder connected: " + this.RecorderInUse.name);
        //        }
        //        else
        //        {
        //            Debug.LogWarning("Local Recorder NOT connected.");
        //        }
        //        if (this.RecorderInUse == null)
        //        {
        ...
        //    //TODO: validate GPT method works
        //    punVoiceClient.AddSpeaker(this.SpeakerInUse, this.photonView.ViewID);
