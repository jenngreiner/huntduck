...
Shader "Polyart/Dreamscape CliffAuto"
{
	Properties
	{
		...
		[ASEBegin]_StoneDirtSharpness("Stone Dirt Sharpness", Float) = 0
		...
		[ASEEnd]_GrassTint("Grass Tint", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			sampler2D _StoneColor;
			sampler2D _DirtColor;
			sampler2D _DirtNormal;
			sampler2D _GrassColour;
			sampler2D _StoneNormal;
			sampler2D _GrassNormal;
			sampler2D _StoneSmooth;
			sampler2D _DirtSmooth;
			sampler2D _GrassSmooth;
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar192 = TriplanarSampling192( _StoneColor, WorldPosition, WorldNormal, 1.0, vCliffTiling197, 1.0, 0 );
				float2 VTiling220 = ( _Tiling / float2( 10,10 ) );
				float4 triplanar194 = TriplanarSampling194( _DirtColor, WorldPosition, WorldNormal, 1.0, VTiling220, 1.0, 0 );
				float4 triplanar195 = TriplanarSampling195( _DirtNormal, WorldPosition, WorldNormal, 1.0, VTiling220, 1.0, 0 );
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal56_g125 = UnpackNormalScale( triplanar195, 1.0 );
				float3 worldNormal56_g125 = normalize( float3(dot(tanToWorld0,tanNormal56_g125), dot(tanToWorld1,tanNormal56_g125), dot(tanToWorld2,tanNormal56_g125)) );
				float3 normalizeResult58_g125 = normalize( float3(0,1,0) );
				float dotResult57_g125 = dot( worldNormal56_g125 , normalizeResult58_g125 );
				...
				float4 triplanar201 = TriplanarSampling201( _GrassColour, WorldPosition, WorldNormal, 1.0, VTiling220, 1.0, 0 );
				float3 normalizedWorldNormal = normalize( WorldNormal );
				float3 normalizeResult44_g126 = normalize( float3(0,1,0) );
				float dotResult45_g126 = dot( normalizedWorldNormal , normalizeResult44_g126 );
				...
				float4 triplanar193 = TriplanarSampling193( _StoneNormal, WorldPosition, WorldNormal, 1.0, vCliffTiling197, 1.0, 0 );
				float4 triplanar213 = TriplanarSampling213( _DirtNormal, WorldPosition, WorldNormal, 1.0, vCliffTiling197, 1.0, 0 );
				float4 lerpResult47 = lerp( triplanar193 , triplanar213 , temp_output_60_55);
				float4 vStoneDirtNormal72 = lerpResult47;
				float4 triplanar205 = TriplanarSampling205( _GrassNormal, WorldPosition, WorldNormal, 1.0, VTiling220, 1.0, 0 );
				float4 lerpResult88 = lerp( vStoneDirtNormal72 , triplanar205 , temp_output_57_25);
				float3 unpack90 = UnpackNormalScale( lerpResult88, _Normal );
				unpack90.z = lerp( 1, unpack90.z, saturate(_Normal) );
				
				float4 triplanar216 = TriplanarSampling216( _StoneSmooth, WorldPosition, WorldNormal, 1.0, vCliffTiling197, 1.0, 0 );
				float4 triplanar217 = TriplanarSampling217( _DirtSmooth, WorldPosition, WorldNormal, 1.0, vCliffTiling197, 1.0, 0 );
				float4 lerpResult81 = lerp( triplanar216 , triplanar217 , temp_output_60_55);
				float4 vStoneDirtSmooth82 = lerpResult81;
				float4 triplanar207 = TriplanarSampling207( _GrassSmooth, WorldPosition, WorldNormal, 1.0, VTiling220, 1.0, 0 );
				float4 lerpResult210 = lerp( vStoneDirtSmooth82 , triplanar207 , float4( 0,0,0,0 ));
				
				float3 Albedo = lerpResult34.rgb;
				float3 Normal = unpack90;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = ( ( 1.0 - lerpResult210 ) * _SmoothnessMultiplier ).x;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar192 = TriplanarSampling192( _StoneColor, WorldPosition, ase_worldNormal, 1.0, vCliffTiling197, 1.0, 0 );
				float2 VTiling220 = ( _Tiling / float2( 10,10 ) );
				float4 triplanar194 = TriplanarSampling194( _DirtColor, WorldPosition, ase_worldNormal, 1.0, VTiling220, 1.0, 0 );
				float4 triplanar195 = TriplanarSampling195( _DirtNormal, WorldPosition, ase_worldNormal, 1.0, VTiling220, 1.0, 0 );
				...
				float4 lerpResult54 = lerp( triplanar192 , triplanar194 , temp_output_60_55);
				float4 vStoneDirtColor61 = lerpResult54;
				float4 triplanar201 = TriplanarSampling201( _GrassColour, WorldPosition, ase_worldNormal, 1.0, VTiling220, 1.0, 0 );
...
/*ASEBEGIN
Version=18912
1186;432;2305;1667;2365.789;1950.626;1;True;False
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;229;-695.7205,-1222.164;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;225;-695.7205,-1222.164;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;226;-695.7205,-1222.164;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;Polyart/Dreamscape CliffAuto;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;227;-695.7205,-1222.164;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;228;-695.7205,-1222.164;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;230;-695.7205,-1222.164;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;226;0;34;0
WireConnection;226;1;90;0
WireConnection;226;4;44;0
ASEEND*/
//CHKSM=A8F4A8B31087F674F248D5B41A781D383C168258